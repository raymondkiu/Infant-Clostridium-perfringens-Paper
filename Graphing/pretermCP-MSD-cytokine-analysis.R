setwd("~/Desktop/pretermCP/Analysis-Rev1/MSD-cytokine-analysis/")
library(ggplot2)
library(tidyverse)
library(ggpubr)
library(rstatix)

data <- read.csv("MSD-data-R.csv", header = TRUE, stringsAsFactors = TRUE)
head(data)
...
# separate bar charts for cytokines
# IFN-g

bc1 <- 
  ggplot(IFNg,aes(x=Group, y=Value, fill=Group)) + geom_bar(position="dodge", stat="identity") +
...
# IL-10
bc2 <- 
  ggplot(IL10,aes(x=Group, y=Value, fill=Group)) + geom_bar(position="dodge", stat="identity") +
  scale_y_continuous(breaks=c(0,2,4,6,8), limits=c(0,8)) +
  geom_errorbar(aes(ymin=Value-se, ymax=Value+se),
                width=.3,                    # Width of the error bars
                position=position_dodge(.9))+
...
# IL-12p70
bc3 <- 
  ggplot(IL12p70,aes(x=Group, y=Value, fill=Group)) + geom_bar(position="dodge", stat="identity") +
  scale_y_continuous(breaks=c(0,2,4,6,8), limits=c(0,8)) +
  geom_errorbar(aes(ymin=Value-se, ymax=Value+se),
                width=.3,                    # Width of the error bars
                position=position_dodge(.9))+
...
# IL-17
bc4 <- 
  ggplot(IL17,aes(x=Group, y=Value, fill=Group)) + geom_bar(position="dodge", stat="identity") +
  scale_y_continuous(breaks=c(0,2,4,6,8), limits=c(0,8)) +
  geom_errorbar(aes(ymin=Value-se, ymax=Value+se),
                width=.3,                    # Width of the error bars
                position=position_dodge(.9))+
...
# IL-1b
bc5 <- 
  ggplot(IL1b,aes(x=Group, y=Value, fill=Group)) + geom_bar(position="dodge", stat="identity") +
...
# IL-22
bc6 <- 
  ggplot(IL22,aes(x=Group, y=Value, fill=Group)) + geom_bar(position="dodge", stat="identity") +
  scale_y_continuous(breaks=c(0,20,40,60,80,100), limits=c(0,100)) +
  geom_errorbar(aes(ymin=Value-se, ymax=Value+se),
                width=.3,                    # Width of the error bars
                position=position_dodge(.9))+
...
# IL-4
bc7 <- 
  ggplot(IL4,aes(x=Group, y=Value, fill=Group)) + geom_bar(position="dodge", stat="identity") +
...
# IL-6
bc8 <- 
  ggplot(IL6,aes(x=Group, y=Value, fill=Group)) + geom_bar(position="dodge", stat="identity") +
  scale_y_continuous(breaks=c(0,0.25,0.5,0.75), limits=c(0,0.75)) +
  geom_errorbar(aes(ymin=Value-se, ymax=Value+se),
                width=.3,                    # Width of the error bars
                position=position_dodge(.9))+
...
# KC/GRO
bc9 <- 
  ggplot(KCGRO,aes(x=Group, y=Value, fill=Group)) + geom_bar(position="dodge", stat="identity") +
  scale_y_continuous(breaks=c(0,50,100,150,200,250), limits=c(0,250)) +
  geom_errorbar(aes(ymin=Value-se, ymax=Value+se),
                width=.3,                    # Width of the error bars
                position=position_dodge(.9))+
