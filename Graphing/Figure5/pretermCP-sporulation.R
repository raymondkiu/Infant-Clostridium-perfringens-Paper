...
# Do a boxplot as requested by editor - bar plots cannot deploy individual points as it is based on stats summary
p <- data %>%
  mutate(Lineage = fct_relevel(Lineage, 
                               "Lineage 1","Lineage 3","Lineage 5","Lineage 6","Lineage 7")) %>% 
...
p + geom_jitter(cex=0.7, colour="grey20") # not good, need Log10 scale
